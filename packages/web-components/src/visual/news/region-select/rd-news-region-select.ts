...
export const RD_NEWS_REGION_SELECT_TAG = 'rd-news-region-select';
...
/** @rosettadash/web-components/visual/news/region-select — visual.news.region-select */
export class RdNewsRegionSelectElement extends RosettaAtomElement {
  static readonly tagName = RD_NEWS_REGION_SELECT_TAG;
  ...
  protected buildMarkup(): string {
    ...
    return `
      <section class="rd-news-region-select" data-testid="rd-news-region-select">
...
export function registerRdNewsRegionSelect(): void {
  defineRosettaElement(RD_NEWS_REGION_SELECT_TAG, RdNewsRegionSelectElement);
}
